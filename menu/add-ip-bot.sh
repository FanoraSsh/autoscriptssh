#!/bin/bash
# // PROJECT XDXL STORE
url_izin="https://raw.githubusercontent.com/FanoraSsh/permission/main/ip"
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mWhatsapp${NC} wa.me/6287835373265"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
git clone https://github.com/FanoraSsh/permission.git /root/ipvps/ &> /dev/null
clear
echo -e ""
